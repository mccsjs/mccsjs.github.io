            ...
            if (owo_body) {
                ...
                owo_body.onmouseover = (e) => {
                    if (flag && e.target.tagName === 'IMG') {
                        flag = 0;
                        owo_time = setTimeout(() => {
                            const height = e.target.clientHeight * m;
                            const width = e.target.clientWidth * m;
...
class LinkStatusChecker {
    constructor() {
        this.retryCount = 0;
        this.MAX_RETRIES = 3;
        this.STATUS_URL = 'https://link.hexo.seln.cn/status.json';
        this.init();
    }
...
// 樱花效果控制
const sakuraController = new SakuraController();

// 图片加载处理
img.onload = function() {
    const allowedPaths = ['/', '/about/', '/link/', '/dcim/', '/bt/'];
